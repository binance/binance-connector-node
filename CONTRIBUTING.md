...
The [issue tracker](https://github.com/binance/binance-connector-node/issues) is
...
1.  [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
    ...
    git clone https://github.com/<your-username>/binance-connector-node.git
    # Navigate to the newly cloned directory
    cd binance-connector-node
    # Assign the original repo to a remote called "upstream"
    git remote add upstream https://github.com/binance/binance-connector-node.git
    ```
...
5.  Locally merge (or rebase) the upstream rc branch into your topic branch:

    ```bash
    git pull [--rebase] upstream <latest_rc_branch>
    ```

6. Execute the document generation script and check the output `.html` file in `/docs` folder to make sure your code change is clearly described.
